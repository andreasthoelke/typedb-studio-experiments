...
test('graph shortcut map includes navigation, live view, saving, finder and help',()=>{
 for(const [name,action] of [['+','zoomIn'],['-','zoomOut'],['Enter','focus'],['r','relayout'],['h','previous'],['l','next'],['Backspace','live'],['s','snap'],['/','find'],['?','help']]) assert.equal(graphShortcut(key(name)),action);
