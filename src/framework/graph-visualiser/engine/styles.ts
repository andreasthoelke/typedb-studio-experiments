...
export const defaultQueryStyleParams: GraphStyles = {
    vertexColors: {
        ...
        // Neutral: role types are structural, not data — they shouldn't compete with data nodes.
        roleType: darkPalette.grey2,
...
export const calAestheticsKindStyles: Record<string, { color: string; shape: string; width: number; height: number }> = {
    ...
    attributeType: { color: darkPalette.nodeOrange, shape: "rounded-rect", width: 52, height: 30 },
    roleType:      { color: "#9c9c9c",              shape: "ellipse",      width: 56, height: 24 },
