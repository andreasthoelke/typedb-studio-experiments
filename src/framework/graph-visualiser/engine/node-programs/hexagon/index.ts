...
import { drawHexagonNodeLabel, drawHexagonNodeHover } from "./utils";
...
export class NodeHexagonProgram<
    N extends Attributes = Attributes,
    E extends Attributes = Attributes,
    G extends Attributes = Attributes,
> extends NodeProgram<(typeof UNIFORMS)[number], N, E, G> {
    override drawHover = drawHexagonNodeHover;
    override drawLabel = drawHexagonNodeLabel;
