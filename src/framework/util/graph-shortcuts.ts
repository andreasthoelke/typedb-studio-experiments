...
export type GraphShortcut = "previous" | "next" | "live" | "snap" | "find" | "help" | "focus";
export function graphShortcut(event: Pick<KeyboardEvent, "key" | "ctrlKey" | "metaKey" | "altKey" | "isComposing" | "defaultPrevented" | "repeat">): GraphShortcut | null {
    ...
    const actions: Record<string, GraphShortcut> = { Enter: "focus", h: "previous", l: "next", Backspace: "live", s: "snap", "/": "find", "?": "help" };
