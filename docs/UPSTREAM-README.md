Original TypeDB Studio README, retained from the upstream project. Relative build links below refer to the repository root.
...
To send Neovim queries into Studio's Query page and fullscreen graph, see the [local integration guide](local-graph-viewer.md).
